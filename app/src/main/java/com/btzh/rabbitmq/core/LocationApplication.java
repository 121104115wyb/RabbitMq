package com.btzh.rabbitmq.core;
...
public class LocationApplication extends Application {
    ...
    private void initMpush() {
        Notifications.I.init(context, null, null, null);
        Notifications.I.setSmallIcon(R.mipmap.ic_launcher);
        Notifications.I.setLargeIcon(BitmapFactory.decodeResource(context.getResources(), R.mipmap.ic_launcher));
    }
